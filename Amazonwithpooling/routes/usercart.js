...
exports.getcart = function(req, res,total){
	...
	mysql.fetchcartdata(function(err,result,total){
			if(err)
			{
				res.statusCode = 400;
			...
			else
			{
				...
				res.render('usercart', { Admin: Isadmin, cartdata : result,userid: usid,username: usname,totalcharge: total });
			}
